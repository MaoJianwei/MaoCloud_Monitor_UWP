...
namespace Syncfusion.UI.Xaml.Controls
{
    ...
    public sealed partial class SpellCheckerDialog : Page,IDisposable
    {
        ...
        int _SubStrlen = 0, currenterrorword = 0;
        ...
        internal void findingerrorword()
        {
            ...
            foreach (string str1 in words)
            {
                ...
                else if (spellChecker.HasError(str1) && !ignorewords.Contains(str1))
                {
        ...
        private void CloseDialog(object sender, RoutedEventArgs e)
        {
            ...
            spellChecker.maingrid.IsHitTestVisible = true;
            this.Dispose();
        }
        ...
        private async void Spell_Ignore(object sender, RoutedEventArgs e)
        {
            UpdateSelection();
            if (currenterrorword >= m_errorlist.Count)
            {
                spellChecker.dialog.IsOpen = false;
                spellChecker.maingrid.IsHitTestVisible = true;
                var message = new MessageDialog("Spell Check is completed");
                await message.ShowAsync();
            }

        }

        private async void Spell_IgnoreAll(object sender, RoutedEventArgs e)
        {
        ...
        private async void Spell_ReplaceAll(object sender, RoutedEventArgs e)
        {
        ...
        private async void Spell_AddToDictionary(object sender, RoutedEventArgs e)
        {
